...
- (void)saveToDisk {
    ...
    [defaults setInteger:ListOfUsersWEB forKey:kListOfUsersKey];
...
//    [QBSettings setApplicationID:31248];
//    [QBSettings setAuthKey:@"77RTqOyF8qGNxHB"];
//    [QBSettings setAuthSecret:@"yHTO2BqwzfexY3L"];
    
    [QBSettings setApplicationID:36950];
    [QBSettings setAuthKey:@"V8YVZxw4K7Zegha"];
    [QBSettings setAuthSecret:@"WyJcJmmarLPbFe3"];
    ...
    if (mediaConfigData) {
        ...
        self.mediaConfiguration.videoCodec = QBRTCVideoCodecH264;
    }
