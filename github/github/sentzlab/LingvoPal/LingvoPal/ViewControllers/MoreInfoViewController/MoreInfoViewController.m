...
@interface MoreInfoViewController () <UIActionSheetDelegate, PortalSessionDelegate>
...
- (void)viewDidLoad {
    ...
    otherLang.text = @"PLEASE CHOOSE OTHER LANGUAGE";
...
-(void) sendRequest{
    ...
    //[session becomeTranslator:[NSString stringWithFormat:@"%@/%@/", self.nativeLangString, self.otherLangString]];
